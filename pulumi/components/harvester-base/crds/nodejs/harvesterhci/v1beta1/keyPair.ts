...
export class KeyPair extends pulumi.CustomResource {
    ...
    public readonly spec!: pulumi.Output<outputs.harvesterhci.v1beta1.KeyPairSpec>;
    public /*out*/ readonly status!: pulumi.Output<outputs.harvesterhci.v1beta1.KeyPairStatus>;
