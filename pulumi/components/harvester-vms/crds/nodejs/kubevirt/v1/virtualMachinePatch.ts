...
export class VirtualMachinePatch extends pulumi.CustomResource {
    ...
    public readonly spec!: pulumi.Output<outputs.kubevirt.v1.VirtualMachineSpecPatch>;
    public /*out*/ readonly status!: pulumi.Output<outputs.kubevirt.v1.VirtualMachineStatusPatch>;
