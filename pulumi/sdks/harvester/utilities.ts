...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("harvester");
			params.setVersion("0.6.7");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL2hhcnZlc3Rlci9oYXJ2ZXN0ZXIiLCJ2ZXJzaW9uIjoiMC42LjcifX0="), c => c.charCodeAt(0)));
